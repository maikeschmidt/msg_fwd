...
geoms_path  = 'D:\Simulations\Pertubations\geoms_elec';   % SET THIS: path to folder containing geometry .mat files
lf_save_path = 'D:\Simulations\Pertubations\fields\bem_elec';  % SET THIS: path to folder where leadfield .mat files will be saved
