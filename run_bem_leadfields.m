...
filenames = {
    'geometries_coreg_rep01_cont', ...
    'geometries_coreg_rep01_inhomo', ...
    'geometries_coreg_rep02_cont', ...
    'geometries_coreg_rep02_inhomo', ...
    'geometries_coreg_rep03_cont', ...
    'geometries_coreg_rep03_inhomo', ...
    'geometries_coreg_rep04_cont', ...
    'geometries_coreg_rep04_inhomo', ...
    'geometries_coreg_rep05_cont', ...
    'geometries_coreg_rep05_inhomo', ...
    'geometries_warp01_realistic', ...
    'geometries_warp02_realistic', ...
    'geometries_warp03_realistic', ...
    'geometries_warp04_realistic', ...
    'geometries_warp05_realistic', ...
    'geometries_warp06_realistic', ...
    'geometries_warp07_realistic', ...
    'geometries_warp08_realistic', ...
    'geometries_warp09_realistic', ...
    'geometries_warp10_realistic', ...
    'geometries_warp11_realistic', ...
    'geometries_warp12_realistic', ...
    'geometries_warp13_realistic', ...
    'geometries_warp14_realistic', ...
    'geometries_warp15_realistic', ...
    'geometries_warp16_realistic', ...
    'geometries_warp17_realistic', ...
    'geometries_warp18_realistic', ...
    'geometries_warp19_realistic', ...
    'geometries_warp20_realistic', ...
    'geometries_warp21_realistic', ...
    'geometries_warp22_realistic', ...
    'geometries_warp23_realistic', ...
    'geometries_warp24_realistic', ...
    'geometries_warp25_realistic', ...
    'geometries_warp26_realistic', ...
    'geometries_warp27_realistic', ...
    'geometries_warp28_realistic', ...
    'geometries_warp29_realistic', ...
    'geometries_warp30_realistic', ...
...
%% STEP 3: Load sensor arrays
    ...
    % both modalities and array configurations without manual configuration.
    %
    % Detection priority:
    %   1. Experimental array  — 'experimental_sensors' (single array,
    %                             arbitrary layout)
    %   2. Standard front/back — 'front_coils_3axis' → 'front_coils_2axis'
    %                             → 'front_sensors' (and equivalent back)
    %   EEG modality is detected separately from the struct fields
    %   (elecpos/chanpos present, coilpos absent)

    % Check for experimental (single) array first 
    if isfield(geoms, 'experimental_sensors')

        % Single experimental array — not split into front/back
    ...
    % Standard front/back array configuration
    else
        ...
        elseif isfield(geoms, 'front_sensors')
            ...
            error('No front sensor structure found in geometry file: %s', ...
                filenames{fIdx});
        end
        ...
        elseif isfield(geoms, 'back_sensors')
            ...
            error('No back sensor structure found in geometry file: %s', ...
                filenames{fIdx});
        end
    ...
    for gIdx = 1:numel(sensor_arrays)
        ...
        outdir  = fullfile(lf_save_path, filenames{fIdx});
