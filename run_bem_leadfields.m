...
geoms_path  = 'D:\Simulations\Pertubations\geometries';   % SET THIS: path to folder containing geometry .mat files
lf_save_path = 'D:\Simulations\Pertubations\fields\bem';  % SET THIS: path to folder where leadfield .mat files will be saved
