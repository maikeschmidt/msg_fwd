...
% Models come from the registry. The heatmap is every-against-every, so it
% takes a model GROUP rather than a pair list.
%   bone_both  all four variants, both solvers   (default)
%   bone_bem   BEM only
%   bone_fem   FEM only
config_comparisons;
